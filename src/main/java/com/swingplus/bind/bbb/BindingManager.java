 ...
 * @since 11/04/2013
 */
public class BindingManager implements Releaseable {
    ...
    public void release() {
        ...
        synchronized (this.lock) {
            ...
            for (Entry<Object, List<Binding<?, ?, ?, ?>>> e : this.bindingMap.entrySet()) {
                BindingManager.release(e.getValue());
            }
    ...
    public void release(Object bean) {
        ...
        synchronized (this.lock) {
            ...
            BindingManager.release(this.bindingMap.get(bean));
